                    ...
                    <div class="layui-card-body">
                        ...
                        <table width="100%" style="margin-left: 10px;">
                            ...
                            <tr>
                                ...
                                <td>客户端下载地址(IOS):<input name="iosDownloadUrl" value="${keywords.iosDownloadUrl}"
                                                        required></td>
                            ...
                            <tr>
                                ...
                                <td>客户端下载地址(Android):<input name="androidDownloadUrl"
                                                            value="${keywords.androidDownloadUrl}" required></td>

                                <td>二维码下载地址(Android):<input name="codeAndroidUrl" value="${keywords.codeAndroidUrl}"
                                                            required></td>
            ...
            <div class="layui-col-md12">
                ...
                <div class="layui-card">
                    ...
                    <div style="width: 100%; text-align: center;">
                        ...
                        <a href="${pageContext.request.contextPath}/jsp/DoorManager/Door.jsp"
