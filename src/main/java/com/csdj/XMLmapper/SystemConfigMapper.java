...
public interface SystemConfigMapper {
	 ...
	 * @return
	 */
	public int add_AccountingTypeInfo(@Param("configTypeName")String configTypeName,@Param("isStart")int isStart);
	 ...
	 * @return
	 */
	public int del_AccountingTypeInfo(@Param("id") Integer id);
     ...
     * @return
     */
    public int upd_ServeYearsInfo(@Param("configValue")String configValue,@Param("id")Integer id);
