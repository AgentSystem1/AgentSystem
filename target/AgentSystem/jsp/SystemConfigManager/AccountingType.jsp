...
<script>
    ...
    function test() {
        layer.confirm('<div style="padding: 50px 30px;" >' + '<b>您正在进行添加操作</b><hr><br>' + '<form action="${pageContext.request.contextPath}/controller/accountingTypeAdd" method="post" id="Sub">类型名称:<input type="text" name="configTypeName" id="configTypeName">' +
    ...
    function updat(thist) {
        ...
        layer.confirm('<div style="padding: 50px 30px;">' + '<b>您正在进行修改操作</b><hr><br>' + '<form action="${pageContext.request.contextPath}/controller/accountingTypeUpd" method="post" id="Sub">类型名称:<input type="text" name="configTypeName" id="configTypeName" value=' + thist.configTypeName + '>' +
...
<script>
    ...
    $(function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/controller/accountingTypeList',
            type: 'post',
            data: null,
            dataType: 'json',
            async: false,
